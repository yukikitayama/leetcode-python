    ...
    def countVowelPermutation(self, n: int) -> int:
        ...
        for i in range(1, n):
            ...
            a_vowel_permutation_count[i] = \
                (e_vowel_permutation_count[i - 1]
                 + i_vowel_permutation_count[i - 1]
                 + u_vowel_permutation_count[i - 1]) \
                % MOD
            e_vowel_permutation_count[i] = \
                (a_vowel_permutation_count[i - 1]
                 + i_vowel_permutation_count[i - 1]) \
                % MOD
            i_vowel_permutation_count[i] = \
                (e_vowel_permutation_count[i - 1]
                 + o_vowel_permutation_count[i - 1]) \
                % MOD
        ...
        result = 0
        result = \
            (a_vowel_permutation_count[n - 1]
             + e_vowel_permutation_count[n - 1]
             + i_vowel_permutation_count[n - 1]
             + o_vowel_permutation_count[n - 1]
