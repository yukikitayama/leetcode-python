...
- Make count variable, which will be returned
"""
    ...
    def minimumSemesters(self, n: int, relations: List[List[int]]) -> int:
        ...
        while queue:
            ...
            for _ in range(len(queue)):
                ...
                for relation in relations:
                    if relation[0] == course + 1:
                        in_degree[relation[1] - 1] -= 1
                        if in_degree[relation[1] - 1] == 0:
                            queue.append(relation[1] - 1)
...
# 25
with open('graph_1136_test_case.txt', 'r') as f:
    lines = f.readlines()
n = int(lines[0])
relations = ast.literal_eval(lines[1])
